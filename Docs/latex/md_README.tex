 \hypertarget{md_README_autotoc_md1}{}\doxysection{Brief description}\label{md_README_autotoc_md1}
...
This simulation is inherited by the Geant4 example {\bfseries{G04}} \href{https://gitlab.cern.ch/geant4/geant4/-/tree/v11.1.1/examples/extended/persistency/gdml/G04}{\texttt{ Link to the G04 example}}.\hypertarget{md_README_autotoc_md2}{}\doxysection{Softwares adopted}\label{md_README_autotoc_md2}
...
\end{DoxyEnumerate}\hypertarget{md_README_autotoc_md3}{}\doxysection{Link and resources}\label{md_README_autotoc_md3}
...
\end{DoxyItemize}\hypertarget{md_README_autotoc_md4}{}\doxysection{Free\+CAD GDML Workbench commands}\label{md_README_autotoc_md4}
Here some useful commands for the utilization of the Free\+CAD Python console with the GDML workbench
\begin{DoxyItemize}
\item ` Free\+CAD.\+get\+Document(\textquotesingle{}Unnamed').get\+Object(\textquotesingle{}GDMLBox\+\_\+\+World\+Box\textquotesingle{}).material = u\char`\"{}\+G4\+\_\+\+Galactic\char`\"{}{\ttfamily \+: Assegnazione del materiale G4\+\_\+\+Galactic al volume world\+Vol -\/}Gui.\+activate\+Workbench(\char`\"{}\+GDML\+\_\+\+Workbench\char`\"{})\`{} \+: Command for the activation of the Workbench GDML
\end{DoxyItemize}
\begin{DoxyEnumerate}
\item `Gui.\+run\+Command(\textquotesingle{}Box\+Command',0){\ttfamily \+: Command for the creation of a G4\+Box for the world volume 2.}Gui.\+Selection.\+add\+Selection(\textquotesingle{}Unnamed\textquotesingle{},\textquotesingle{}LV\+\_\+\+Box\textquotesingle{}){\ttfamily \+: Select the part containing the world volume 3.}Gui.\+Selection.\+add\+Selection(\textquotesingle{}Unnamed\textquotesingle{},\textquotesingle{}LV\+\_\+\+Box\textquotesingle{},\textquotesingle{}GDMLBox\+\_\+\+Box.\textquotesingle{}){\ttfamily Select the GDML Box object under the respective part 4.}Free\+CAD.\+get\+Document(\textquotesingle{}Unnamed\textquotesingle{}).get\+Object(\textquotesingle{}GDMLBox\+\_\+\+Box\textquotesingle{}).material = u\char`\"{}\+G4\+\_\+\+Galactic\char`\"{}{\ttfamily \+: Change the material of the G4\+Box 5.}Free\+CAD.\+get\+Document(\textquotesingle{}Unnamed\textquotesingle{}).get\+Object(\textquotesingle{}LV\+\_\+\+Box\textquotesingle{}).Label = \char`\"{}world\+Vol\char`\"{}{\ttfamily \+: rename the object label 6.}Gui.\+active\+View().set\+Active\+Object(\textquotesingle{}part\textquotesingle{}, App.\+active\+Document().Part)\`{} Generate a part inside the document
\item Change the link between the parts. Move the created part under the world volume part 
\begin{DoxyCode}{0}
\DoxyCodeLine{App.getDocument('Unnamed').getObject('Part').adjustRelativeLinks(App.getDocument('Unnamed').getObject('LV\_Box'))}
\DoxyCodeLine{}
\DoxyCodeLine{App.getDocument("{}Unnamed"{}).getObject("{}LV\_Box"{}).addObject(App.getDocument("{}Unnamed"{}).getObject("{}Part"{}))}

\end{DoxyCode}

\item `Free\+CAD.\+get\+Document(\textquotesingle{}Unnamed').get\+Object(\textquotesingle{}Part\textquotesingle{}).Label = \char`\"{}\+LEM\+\_\+\+Assembly\char`\"{}\`{} Rename the part under the world volume to \char`\"{}\+LEM\+\_\+\+Assembly\char`\"{}. Here we have to put the solids from the step file
\end{DoxyEnumerate}\hypertarget{md_README_autotoc_md5}{}\doxysection{Run the simulation}\label{md_README_autotoc_md5}
\hypertarget{md_README_autotoc_md6}{}\doxysubsection{With visualization}\label{md_README_autotoc_md6}
...
\end{DoxyCode}
\hypertarget{md_README_autotoc_md7}{}\doxysection{Detector concept}\label{md_README_autotoc_md7}
...
\item A first Silicon layer \$100 \textbackslash{} \textbackslash{}mu m\$ thick. This is the \$\textbackslash{}\+Delta E\$ layer in which only a small fraction of the energy is deposited. This amount of energy is sometimes called Linear Energy Transfer (LET). This because ~\newline
 \$\$ \textbackslash{}\+Delta E \textbackslash{}approx \textbackslash{}biggl$\vert$ -\/ \textbackslash{}frac\{1\}\{\textbackslash{}rho\} \textbackslash{}frac\{dE\}\{dx\} \textbackslash{}biggr$\vert$ \textbackslash{}rho\+\_\+\{Si\} \textbackslash{}times \textbackslash{}\+Delta x \$\$
...
The detector is based on the \$\textbackslash{}\+Delta E -\/ E\$ technique. This simulation is aimed at characterising the energy deposition inside the materials using the correct geometry of the instrument.\hypertarget{md_README_autotoc_md8}{}\doxysection{Directory structure}\label{md_README_autotoc_md8}
...
\end{DoxyCode}
\hypertarget{md_README_autotoc_md9}{}\doxysection{Doxygen documentation}\label{md_README_autotoc_md9}
Doxygen documentation is available in the {\ttfamily Docs} folder. To generate it, run the following command in the main directory
...
\end{DoxyCode}
 To generate the pdf you need to add to the preamble of the {\ttfamily refman.\+tex} file the following line 
\begin{DoxyCode}{0}
\DoxyCodeLine{\(\backslash\)usepackage\{pmboxdraw\}}
